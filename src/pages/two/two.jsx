...
const Enum = {
  T2_HEAD_CLOTH_SET1: "Колпак ученого (новичок)",
  T2_ARMOR_CLOTH_SET1: "Мантия ученого (новичок)",
  T2_SHOES_CLOTH_SET1: "Сандалии ученого (новичок)",
  T2_OFF_BOOK: "Книга заклинаний (новичок)",
  T2_HEAD_LEATHER_SET1: "Капюшон наемника (новичок)",
  T2_ARMOR_LEATHER_SET1: "Куртка наемника (новичок)",
  T3_SHOES_LEATHER_SET1: "Ботинки наемника (новичок)",
  T2_2H_BOW: "Лук (новичок)",
  T2_HEAD_PLATE_SET1: "Шлем солдата (новичок)",
  T2_ARMOR_PLATE_SET1: "Броня солдата (новичок)",
  T2_SHOES_PLATE_SET1: "Сапоги солдата (новичок)",
  T2_MAIN_SWORD: "Палаш (новичок)",
  T2_2H_TOOL_SIEGEHAMMER: "Молот (новичок)",
  T2_OFF_SHIELD: "Щит (новичок)",
  T2_BAG: "Сумка (новичок)",
  T2_CAPE: "Плащ (новичок)",
};
...
function App() {
  ...
  function addFitch() {
    fetch(
      `https://www.albion-online-data.com/api/v2/stats/prices/T2_HEAD_CLOTH_SET1,T2_ARMOR_CLOTH_SET1,T2_SHOES_CLOTH_SET1,T2_OFF_BOOK,T2_HEAD_LEATHER_SET1,T2_ARMOR_LEATHER_SET1,T3_SHOES_LEATHER_SET1,T2_2H_BOW,T2_HEAD_PLATE_SET1,T2_ARMOR_PLATE_SET1,T2_SHOES_PLATE_SET1,T2_MAIN_SWORD,T2_2H_TOOL_SIEGEHAMMER,T2_OFF_SHIELD,T2_BAG,T2_CAPE?locations=Caerleon,BlackMarket,Martlock,Thetford,Lymhurst,FortSterling,Bridgewatch&qualities=${qualities}`
    )
      .then((res) => res.json())
